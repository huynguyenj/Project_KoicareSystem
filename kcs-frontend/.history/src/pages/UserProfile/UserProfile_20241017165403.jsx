...
function UserProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    await updateInfo(formData.userId,formData).then(()=>toast.success("Thông tin của bạn đã được cập nhật thành công!")).catch((error)=> toast.error("Cập nhật thông tin không thành công!"))
  };
