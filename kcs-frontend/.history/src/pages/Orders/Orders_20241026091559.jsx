...
import { InputBase, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography,Button } from '@mui/material';
...
const Orders = () => {
  ...
  const handleOrderChange = (e)=>{
    const order = <e className="target value"></e>
  }
   ...
   <TableContainer component={Paper} sx={{mt:5}}>
    ...
    <InputBase placeholder='search'
      ...
      <Button
          ...
          >
          {order =="newest"? "Ngày mới nhất":"Ngày cũ"}
      </Button>
