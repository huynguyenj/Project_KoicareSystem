            ...
            {paramHistory ? (
              <>
                 <LineChart
                        ...
                        series={[
                              {dataKey:'no2', color:'#1976d2', label:'NO2',valueFormatter:(v)=>(v==null? '' :`${v} mg/l`)},
                              {dataKey:'o2', color:'#212121', label:'Oxi',valueFormatter:(v)=>(v==null? '' :`${v} mg/l`)},
                              // {dataKey:'ph', color:'#9fd3c7', label:'Nồng độ PH'},
                              {dataKey:'no3', color:'#82ca9d', label:'NO3',valueFormatter:(v)=>(v==null? '' :`${v} mg/l`)},
                              {dataKey:'po4', color:'#142d4c', label:'PO4',valueFormatter:(v)=>(v==null? '' :`${v} mg/l`)},
                              {dataKey:'salinity', color:'red', label:'Độ mặn',valueFormatter:(v)=>(v==null? '' :`${v} mg/l`)},
