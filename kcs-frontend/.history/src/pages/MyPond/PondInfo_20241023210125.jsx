...
function PondInfo() {
    ...
    const getWaterParam = async () => {
        ...
        try {
           const res =  await getPondWaterParam(pond.pondId);
            setWaterParam(res.result)
        } catch (error) {
            console.log(error)
        ...
        <div>
            ...
            <Box sx={{
                ...
                <Grid container spacing={2}>
                    ...
                    <div item xs={12} sm={6} style={style.container2}>
                    <h2 style={style.h2}>Thông số nước</h2>
                        <div style={style.buttonContainer}>
                            {isAdding ? (
                                <>
                                    <Button 
                                    ...
                                    <Button 
                                        variant="contained" 
                                        color="error" 
                                        onClick={handleCancelWaterParam} 
                                        style={style.button}
                                    >
                                        Hủy
                                    </Button>
                        ...
                        <div style={style.fieldContainer}>
                            {isEditing ? (
                                ...
                                <>
            <p style={style.p}>Thời gian đo: {new Date(waterParam.measurementTime).toLocaleDateString() == "Invalid Date" ? "" : new Date(waterParam.measurementTime).toLocaleDateString()}</p>
            <p style={style.p}>Nhiệt độ: {waterParam.temperature==null? "": waterParam.temperature}°C</p>
            <p style={style.p}>Độ mặn: {waterParam.salinity==null? "":waterParam}%</p>
            <p style={style.p}>Độ PH: {waterParam.ph==null? "":waterParam}</p>
            <p style={style.p}>Nồng độ O2: {waterParam.o2==null? "":waterParam}%</p>
            <p style={style.p}>Nồng độ NO2: {waterParam.no2==null? "":waterParam}%</p>
            <p style={style.p}>Nồng độ NO3: {waterParam.no3==null? "":waterParam}%</p>
            <p style={style.p}>Nồng độ PO4: {waterParam.no4==null? "":waterParam}%</p>
                                </>
