...
function PondInfo() {
    ...
    const handleAddWaterParam = (e) => {
        const { name, value } = e.target;
        setWaterParama({ ...waterData, [name]: value });
    };

    const handleSaveWaterParam = () =>{
    ...
    return (
        <div>
            ...
            <p style={style.p}>Độ mặn: {waterParam.salinity}%</p>
            <p style={style.p}>Độ PH: {waterParam.ph}</p>
            <p style={style.p}>Nồng độ O2: {waterParam.o2}%</p>
            <p style={style.p}>Nồng độ NO2: {waterParam.no2}%</p>
            <p style={style.p}>Nồng độ NO3: {waterParam.no3}%</p>
            <p style={style.p}>Nồng độ PO4: {waterParam.no4}%</p>
                                </>
