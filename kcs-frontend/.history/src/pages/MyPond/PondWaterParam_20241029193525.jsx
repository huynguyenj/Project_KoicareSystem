            ...
            {paramHistory ? (
              <>
                 <LineChart
                        ...
                        series={[
                              {dataKey:'no2', color:'#1976d2', label:'NO2'},
                              {dataKey:'o2', color:'#212121', label:'Oxi'},
                              // {dataKey:'ph', color:'#9fd3c7', label:'Nồng độ PH'},
                              {dataKey:'no3', color:'#82ca9d', label:'NO3'},
                              {dataKey:'po4', color:'#142d4c', label:'PO4'},
                              {dataKey:'salinity', color:'red', label:'Độ mặn'},
                              // {dataKey:'temperature', color:'#f96d00', label:'Nhiệt độ hồ'}
                        ]}
                        sx={{ '& .MuiLegend-root': { marginTop: '20px' } }}
                        tooltip={{ formatter: (value) => `${value} mg/cm` }} // Tooltips
                 />
              </>
            ) : (
