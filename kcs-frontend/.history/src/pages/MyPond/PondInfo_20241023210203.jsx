...
function PondInfo() {
    ...
    return (
        <div>
            ...
            <p style={style.p}>Độ mặn: {waterParam.salinit}%</p>
            <p style={style.p}>Độ PH: {waterParam.p}</p>
            <p style={style.p}>Nồng độ O2: {waterParam.o}%</p>
            <p style={style.p}>Nồng độ NO2: {waterParam.no}%</p>
            <p style={style.p}>Nồng độ NO3: {waterParam.no}%</p>
            <p style={style.p}>Nồng độ PO4: {waterParam.no}%</p>
                                </>
