    ...
    const handleSave = async () => {
        if (validateFields()) {
            ...
            data.append("pondName", pondData.name);
             ...
             // Check if pondData.image is a base64 string (indicating it's already an uploaded image)
        if (typeof pondData.image === 'string') {
            // If it's a string (likely base64), set pondImg to null, or you could keep the same image.
            data.append("pondImg", null);
        } else if (pondData.image instanceof File) {
