            ...
            <Box sx={{
                ...
                <Grid container spacing={2}>
                    <div item xs={12} sm={4} style={style.container1}>
                        ...
                        />
                        <p style={style.p}>Ngày tạo: {new Date(pondData.creationDate).toLocaleDateString()}</p>
                        <Button 
                            component={Link} 
                    ...
                    <div item xs={12} sm={6} style={style.container2}>
                        ...
                        <div style={style.fieldContainer}>
                            {isEditing ? (
                                ...
                                <>
            <p style={style.p}>: {Array.isArray(pond.fishResponses) ? pond.fishResponses.length : 0}</p>
