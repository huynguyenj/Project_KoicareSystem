...
function PondInfo() {
    ...
    const handleSave = async () => {
        if (validateFields()) {
            ...
            data.append("size", po.size);
            data.append("depth", po.depth);
            data.append("volume", po.volume);
            data.append("drainCount", po.drainCount);
            data.append("pumpCapacity", po.pumpCapacity);
            console.log("Form submitted:", po);
            console.log('Saving changes:', po);
            setIsEditing(false);
        }
    };
