                    ...
                    <h2 style={style.h2}>Thông số nước</h2>
                        ...
                        <div style={style.fieldContainer}>
                            {isEditing ? (
                                ...
                                <>
            <p style={style.p}>Thời gian đo: {new Date(new Date(pond.date).toLocaleDateString()).toLocaleDateString()}</p>
            <p style={style.p}>Nhiệt độ: {new Date(pond.date).toLocaleDateString()}</p>
            <p style={style.p}>Độ mặn: {pond.size}m</p>
            <p style={style.p}>Độ PH: {pond.depth}m</p>
            <p style={style.p}>Nồng độ O2: {pond.volume}l</p>
            <p style={style.p}>Nồng độ NO2: {pond.drainCount} cái</p>
            <p style={style.p}>Nồng độ NO3: {pond.pumpCapacity}w</p>
            <p style={style.p}>Nồng độ PO4: {pond.pumpCapacity}w</p>
                                </>
