...
function PondInfo() {
    ...
    return (
        <div>
            ...
            <p style={style.p}>Độ mặn: {waterParam.salinity==null}%</p>
            <p style={style.p}>Độ PH: {waterParam.ph==null}</p>
            <p style={style.p}>Nồng độ O2: {waterParam.o2==null}%</p>
            <p style={style.p}>Nồng độ NO2: {waterParam.no2==null}%</p>
            <p style={style.p}>Nồng độ NO3: {waterParam.no3==null}%</p>
            <p style={style.p}>Nồng độ PO4: {waterParam.no4==null}%</p>
                                </>
