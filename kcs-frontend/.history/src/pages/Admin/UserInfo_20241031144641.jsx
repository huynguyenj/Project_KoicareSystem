...
function UserInfo() {
  ...
  const listSort = (query)=>{
    const listUser = users.filter((u)=> u.roles.map(role=>role.userType).toLowerCase().includes(query.toLowerCase()))
      ...
      <Box sx={{ p: 3 }}>
        <Box sx={{ mb: 2, display: "flex"}}>
          ...
          >
            ...
            <option value="ADMIN">Shop</option>
            <option value="SHOP">Unshop</option>
            <option value="USER">Unshop</option>
          </select>
        </Box>
