    ...
    <div>
      ...
      <div className="grid-container">
        ...
        <div className="row" style={{ textAlign: "center" }}>
          {koiFishList.length > 0 ? (koiFishList.map((fish) => (
...
>
  <MenuItem onClick={() => { /* handle choice 1 */ handleCloseMenu(); }}>Choice 1</MenuItem>
  <MenuItem onClick={() => { /* handle choice 2 */ handleCloseMenu(); }}>Choice 2</MenuItem>
  <MenuItem onClick={() => { /* handle choice 3 */ handleCloseMenu(); }}>Choice 3</MenuItem>
</Menu>
                  </div>
                </div>
              </div>
