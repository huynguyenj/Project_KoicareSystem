...
const FishForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("pondName", formData);
    data.append("pondImg", formData.pon);
    data.append("size", formData.);
    data.append("depth", formData.d);
    data.append("volume", formData.vo);
    data.append("drainCount", formData.drainC);
    data.append("pumpCapacity", formData.pumpCapa);
