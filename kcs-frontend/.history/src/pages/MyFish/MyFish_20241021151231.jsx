      ...
      <div className='grid-container' >
        ...
        <div className="row" style={{ textAlign: 'center' }}>
          ...
          {koiFishList.map((fish) => (
            <div className="col-md-4" key={fish.fishId}>
              <div className="container">
                <div className="row justify-content-center">
                  <img src={fish.fishImg} alt={fish.fishName} style={{ width: '90%', height: '200px', margin: '20px 0', objectFit: 'cover', borderRadius: '10px' , backgroundColor: '#f0f0f0'}} />
