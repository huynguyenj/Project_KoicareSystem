            ...
            <div className="col-md-3" key={fish.fishId}>
              <div className="container">
                <div className="row justify-content-center">
                  <img src={fish.fishImg} alt={fish.fishName} style={{ width: '80%', height: '200px', margin: '20px 0', objectFit: 'cover', borderRadius: '10px' , backgroundColor: '#f0f0f0'}} />
                  <div className="col-1" style={style.button}>
