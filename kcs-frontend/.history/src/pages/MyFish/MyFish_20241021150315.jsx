          ...
          {koiFishList.map((fish) => (
            <div className="col-md-3" key={fish.fishId}>
              <div className="container">
                ...
                <div style={{ width: '100%', height: '200px', overflow: 'hidden' }}> {/* Added a container for fixed height */}></div>
                  <img src={fish.fishImg} alt={fish.fishName} style={{ width: '200px', height: '200px', margin: '20px 0', objectFit: 'contain', borderRadius: '10px' , backgroundColor: '#f0f0f0'}} />
