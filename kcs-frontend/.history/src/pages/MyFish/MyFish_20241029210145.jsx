                  ...
                  <Box>
                    ...
                    <CardContent>
                      <Grid
                        ...
                        sx={{ mb: 2,alignItems:'center', textAlign:'center',alignContent:'center' }}
                      >
                        <Grid item>
                          <Button
                            color="error"
                      ...
                      <Typography sx={{mb:2, textAlign:'center',backgroundColor:''}}>{fish.fishName}</Typography>      
                      <Link
                        to={`/userhome/myfishlist/fishinfo/${fish.fishId}`}
                        style={{ textDecoration: "none", marginTop: "",margin:'auto' }}
                      >
                        <Button variant="contained">Xem thông tin chi tiết</Button>
                      </Link>
                    </CardContent>
                  </Box>
                </Card>
