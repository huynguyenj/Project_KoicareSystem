...
function MyFishList() {
  ...
  const handleClick = (fishId)=>{
    setSelectedFishId(fishId); // Store the selected fish ID
    setStatsMenuAnchor(null)
    navigator(`/userhome/addDevelop/${selectedFishId}`)
  }

  const changeToPageShowHistory = (fishId) =>{
    setSelectedFishId(fishId); // Store the selected fish ID
    setStatsMenuAnchor(null)
    navigator(`/userhome/fishDevelopment/${selectedFishId}`)
  }
  return (
    <div>
      <ToastContainer />
                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-2" style={style.button}>
                      ...
                      >
                        ...
                        <MenuItem onClick={() => changeToPageShowHistory(fish.fishId)}>
