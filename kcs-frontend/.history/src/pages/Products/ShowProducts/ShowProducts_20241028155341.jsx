...
import { InputBase, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, IconButton, TablePagination, FormControl, InputLabel, Select } from '@mui/material';
...
const ShowProducts = () => {
  ...
  const handleSave = async (productId) => {
    try {
      ...
      // await updateProduct(productId, editedData);
