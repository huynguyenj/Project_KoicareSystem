                ...
                <div className="charts-container">
                  <BarChart
                    ...
                    yAxis={[{
                      title: 'Doanh thu (VNĐ)',
                      min: 0,
                      max: 30000000, // Adjust this max value as needed
                      tickValues: [0, 5000000, 10000000, 15000000, 20000000, 25000000, 30000000], // Customize tick values
                      labelFormatter: (value) => value.toLocaleString("vi-VN", { maximumFractionDigits: 0 })
                    }]}
                    margin={{ top: 10, bottom: 30, left:110, right: 80 }}
                  />
