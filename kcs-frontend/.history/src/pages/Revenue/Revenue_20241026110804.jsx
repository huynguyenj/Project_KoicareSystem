                    ...
                    yAxis={[
                      {
                        ...
                        title: 'Doanh thu (VNĐ)', // Set the title of the y-axis
                        min: 0, // Minimum value for the y-axis
                        max: Math.max(...monthlyData) + 1000, // Adjust maximum value based on data
                        ticks: Array.from({length: 6}, (_, i) => i * 1000), // Custom tick marks
                      }
                    ]}
