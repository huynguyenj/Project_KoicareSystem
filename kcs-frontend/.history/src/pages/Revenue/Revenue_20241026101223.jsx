...
const chartData = prepareChartData();
  return (
    <div className="Revenue-container">
      ...
      {[orders.map((order)=> new Date(order.date).getFullYear())].map((title, index) => (
            ...
            <div className="revenue-content">
              {orders.length > 0 ? (
                 ...
                 <BarChart
                  ...
                  height={290}
                  xAxis={[{ data: [,'Tháng 2','Tháng3','Tháng 4','Tháng 5','Tháng 6','Tháng 7','Tháng 8', 'Tháng 9', 'Tháng 10', 'Tháng 11'], scaleType: 'band' }]} // Month labels
