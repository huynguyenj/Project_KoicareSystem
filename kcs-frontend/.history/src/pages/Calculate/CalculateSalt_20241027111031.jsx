...
function CalculateSalt() {
      ...
      const calculateSaltDependOnHealth = ()=>{
        ...
        if(healthStatus =="normal"){
          return pondChoice.volume * 0.03.toFixed(2)
        }

        if(healthStatus =="recomend"){
          return pondChoice.volume* 0.05.toFixed(1)
        }

        if(healthStatus =="sick"){
          return pondChoice.volume* 0.07.toFixed(1)
        }
        else return;
      }
  return (
                    ...
                    >
                     ...
                     (
                      <Box mt={1} bgcolor="lightBlue" borderRadius={2}>
                          ...
                          <Typography>Thể tích hồ của bạn: {pondChoice.volume} l</Typography>
