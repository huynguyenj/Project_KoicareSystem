    ...
    <Container sx={{ width: "75%" }}>
      <Grid item xs={12} sm={5}>
        <Card sx={{ padding: 5, border: "AppWorkspace" }}>
          ...
          <FormControl sx={{width:"30%", mb:4}}>
        <InputLabel id="demo-simple-select-label">Hồ của tôi</InputLabel>
        <Select
        ...
        >
          {ponds.map((pond)=>(
            <MenuItem key={pond.pondId} value = {pond.pondName}>{pond.pondName}</MenuItem>
          ))}
        </Select>
      </FormControl>
