  ...
  return (
    <div>
      <Card sx={{maxWidth:350, margin:'auto',mt:5}}>
            <CardContent>
                  <Typography variant='h4,contained' sx={{backgroundColor:'green',color:'white',textAlign:'center',mb:2,padding:2}}>Thông số của hồ</Typography>
                  <Typography variant='h5'>Tên hồ:  {waterParam.pondName}</Typography>
