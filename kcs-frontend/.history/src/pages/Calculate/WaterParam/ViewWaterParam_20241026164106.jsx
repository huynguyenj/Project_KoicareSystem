    ...
    <div>
      <Card sx={{ maxWidth: 400, margin: 'auto', mt: 5, boxShadow: 3, borderRadius: 2 }}>
        <CardContent>
          ...
          <Typography>
            <strong>Nhiệt độ:</strong> <span style={{ color: '#ff7043' }}>{waterParam.temperature}°C</span>
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Độ mặn:</strong> <span style={{ color: '#29b6f6' }}>{waterParam.salinity}%</span>
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Độ pH:</strong> <span style={{ color: '#66bb6a' }}>{waterParam.ph}</span>
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Nồng độ O2:</strong> <span style={{ color: '#ef5350' }}>{waterParam.o2}%</span>
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Nồng độ NO2:</strong> {waterParam.no2}%
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Nồng độ NO3:</strong> {waterParam.no3}%
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            <strong>Nồng độ PO4:</strong> {waterParam.po4}%
          </Typography>
