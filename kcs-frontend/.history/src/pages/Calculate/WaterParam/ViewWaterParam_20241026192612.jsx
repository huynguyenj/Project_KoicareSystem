    ...
    <div>
      <Card sx={{ maxWidth: 400, margin: 'auto', boxShadow: 3, borderRadius: 2 }}>
        <CardContent>
          ...
          <Divider sx={{ my: 1 }} />
          <Typography>
            Nồng độ O2: <span style={{ color: '#ef5350' }}>{waterParam.o2}mg/l</span>
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            Nồng độ NO2: {waterParam.no2}mg/l
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            Nồng độ NO3: {waterParam.no3}mg/l
          </Typography>
          <Divider sx={{ my: 1 }} />
          <Typography>
            Nồng độ PO4: {waterParam.po4}mg/l
          </Typography>
          ...
          (<Alert variant='filled' severity='warning' sx={{mt:2}}>
           ...
           <Button>Cập nhật lại thông số nước</Button>
      )}
        </CardContent>
      </Card>
    </div>
