...
function ViewWaterParam() {
  ...
  const recommendProduct = () =>{
      if(recomendation){
       ...
       const no2re = recomendation.NO2 || "";
       const no3re = recomendation.NO3 || "";
       const o2re = recomendation.O2 || "";
       const po4re = recomendation.PO4 || "";
       const phre = recomendation.pH || "";
       const nhietDoSuggestion = waterParameters['Nhiệt độ'];
       console.log(nhietDoSuggestion);
