  ...
  return (
    <div>
      <Card sx={{maxWidth:350, margin:'auto',mt:5,boxShadow: 3, borderRadius: 2 }}>
            <CardContent>
                  <Typography variant='h4' sx={{backgroundColor:'green',color:'white',textAlign:'center',mb:2,padding:2,border:1}}>Thông số của hồ</Typography>
                  <Typography variant='h5'>{waterParam.pondName}</Typography>
