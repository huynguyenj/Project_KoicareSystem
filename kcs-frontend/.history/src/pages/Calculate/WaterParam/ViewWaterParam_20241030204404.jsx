      ...
      if(recomendation){
       console.log(recomendation)
          if(key =="O2"){
            ...
            setRecomendProduct({...recomendProduct, temp : productsList.filter(p => p.category == "RESOLVE_SALINITY")})
            console.log(recomendProduct.temp)
          }
          if(key == "pH"){
            setRecomendProduct({...recomendProduct, temp : productsList.filter(p => p.category == "RESOLVE_PH")})
            console.log(recomendProduct.temp)
          }
          if(key == "NO2"){
            setRecomendProduct({...recomendProduct, temp : productsList.filter(p => p.category == "RESOLVE_NO2")})
            console.log(recomendProduct.temp)
          }
          if(key == "NO3"){
            setRecomendProduct({...recomendProduct, temp : productsList.filter(p => p.category == "RESOLVE_NO3")})
            console.log(recomendProduct.temp)
          }
      }
  }
