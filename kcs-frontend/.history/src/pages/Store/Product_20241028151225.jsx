...
const Product = () => {
  ...
  const filteredProducts = Array.isArray(productsList)
    ? productsList
        .filter((product) =>
          product.productproduct.productName.toLowerCase().includes(searchTerm.toLowerCase())
        )
                ...
                >
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    >
                      ...
                      <Chip
                        label={product.price > 0 ? "Còn hàng" : "Hết hàng"}
                        color={product.price > 0 ? "success" : "error"}
                        size="small"
                      />
                    </Box>
                    {/* <Rating
