      ...
      <Box sx={{ mt: 4 }}>
        ...
        {show ? (
          <>
            ...
            <TextField label="Ý kiến về sản phẩm" name="content" onChange={handleChange}></TextField>
            <Box>
              {imagePreview ? (
                <>
                  <img
            ...
            {loading? <CircularProgress color="inherit"></CircularProgress>: <Button onClick={() => handleSubmit()}>}
