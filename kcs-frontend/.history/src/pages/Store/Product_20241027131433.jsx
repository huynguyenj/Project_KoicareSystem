...
import { useCart } from "../path/to/useCart"; // replace with actual path
import { getAllProduct } from "../path/to/api"; // replace with actual path
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 1, mb: 4 }}>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          Bạn có muốn thêm sản phẩm {selectedProduct?.productName} vào giỏ hàng không?
        </DialogContent>
        <DialogActions>
