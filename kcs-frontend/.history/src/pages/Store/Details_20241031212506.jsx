...
const Detail = () => {
  ...
  const handleImageChange = (e)=>{
      ...
      setComment({...blogData, image: file }); // Update the image property with the selected file
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography 
      variant="h4" 
      sx={{mb:2,alignItems:'center',alignContent:'center', textAlign:'center'}} 
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Button variant="contained" sx={{mt:2}} onClick={()=>setShow(true)}>Đánh giá</Button>
        </>
      }
