...
import {  getMyBlogs } from "../../api/userService";
    ...
    <ToastContainer
     ...
     pauseOnFocusLoss/>
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4, textAlign: "center" }}>
        ...
        {listBlogs!=null ? "": <Typography variant="h6">Không tìm thấy dữ liệu</Typography>}
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Button onClick={()h=></CardContent>andleDelete()}>Delete</Button>
                  </CardContent>
                </CardActionArea>
              </Card>
            </Grid>
