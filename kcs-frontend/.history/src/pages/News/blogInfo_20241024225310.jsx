...
import { Container, Typography, CardMedia, CardContent, Card, AppBar, InputBase, Toolbar, IconButton, CircularProgress } from '@mui/material';
    ...
    <Container maxWidth="md" sx={{ marginTop: 4 }}>
      <Card>
        ...
        <CardContent>
          ...
          <Typography variant="body1" color="black" dangerouslySetInnerHTML={{ __html: blog.content }} />
        </CardContent>
      </Card>
    </Container>
    </>
