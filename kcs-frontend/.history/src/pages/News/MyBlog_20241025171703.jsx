     ...
     pauseOnFocusLoss/>
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4, textAlign: "center" }}>
        ...
        <Button onClick={toggleOrder}>
          Sắp xếp theo ngày ({sortOrder === "newest" ? "Newest First" : "Oldest First"})
        </Button>
        ...
        <Grid container spacing={4}>
          {sortItem.length > 0 ? (sortItem.map((item) => (
            ...
            <Typography variant="h6" sx={{textAlign:'center', width:'100%', mt:5}}>Không tìm thấy kết quả</Typography>
          }
        </Grid>
      </Container>
    </>
