...
const News = () => {
  ...
  const sort = (blogs)=>{
    return sortOrder =="newest"? [...blogs.sort((a,b)=>new Date(b.publishedDate) - new Date(a.publishedDate))]
  }

  const toggleSortOrder = () => {
    setSortOrder((prevOrder) => (prevOrder === "newest" ? "oldest" : "newest"));
    setSortedBlogs(sortBlogsByDate(filterBlogs(searchQuery)));
  };
