    ...
    <>
      <Box maxWidth={400} sx={{ margin: "auto",textAlign:'center' }}>
        <Card>
          ...
          <Typography>
                   {orderInfo.userName!=null? ("Tên người mua: ", orderInfo.userName):""}
          </Typography>
          <Typography>
                   {orderInfo.address!=null? ("Địa chỉ: ",orderInfo.address): ""}
          </Typography>
          <Typography>
                   {orderInfo.phone!=null? ("Số điện thoại: ",orderInfo.phone):""}
          </Typography>
