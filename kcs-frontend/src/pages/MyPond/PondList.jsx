...
import { Button, CircularProgress, Grid, Typography, Card, CardContent, CardMedia, Container, Tooltip } from "@mui/material";
...
function PondList() {
  ...
  const handleDeletePond = async (pondId) => {
    const confirmDelete = window.confirm("Bạn có chắc bạn muốn xóa hồ này?");
                ...
                <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
                  ...
                  <CardContent>
                    ...
                    <Grid container spacing={1} justifyContent="space-around">
                      ...
                      <Grid item>
                      <Tooltip title = {"Thông số hồ cá"} arrow>
                        <Button component={Link} to={`/userhome/viewparam/${pond.pondId}`} color="success">
                          <WaterIcon />
                        </Button>
                        </Tooltip>
                      </Grid>
                      <Grid item>
                      <Tooltip title = {"Xem thông số hồ mỗi kì"} arrow>
