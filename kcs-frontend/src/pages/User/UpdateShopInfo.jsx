...
function UpdateShopInfo() {
  ...
  const validate = () =>{
      const newError = {}
      if(!shopInfo.shopName || shopInfo.shopName.trim() == "" ){
  ...
  const handleSave = async () =>{
      try {
            if(validate()){
                  ...
                  await updateShop(shopInfo.shopId,shopInfo)
          ...
          <>
            ...
            >
              <CardContent>
                ...
                { !shopInfo ? 
                <>
                 <Alert sx={{mt:2}} severity="info">Lấy dữ liệu không thành công hãy đăng nhập lại hoặc tạo shop</Alert>
                </>:<> 
                <Typography sx={{ mt: 2 }}>
