...
export const checkPassword = async (oldPassword) =>{
      try {
            ...
            const res = await axios.post(`${REST_API_BASE_URL}/auth/user/checkPass`,oldPassword,{
                  headers: {
                        Authorization: `Bearer ${token}`,
...
export const changePassword = async (newPassword) =>{
      try {
            ...
            const res = await axios.patch(`${REST_API_BASE_URL}/auth/user/ChangePassword`,newPassword,{
                  headers: {
                        Authorization: `Bearer ${token}`,
...
export const getMyPayment = async ()=>{
      try {
            ...
            const res = await axios.get(`${REST_API_BASE_URL}/api/getPayment`,{
                  headers: {
                        Authorization: `Bearer ${token}`,
